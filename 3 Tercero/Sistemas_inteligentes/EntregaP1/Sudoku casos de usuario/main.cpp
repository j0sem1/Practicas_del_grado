...
int main(int argc, char **argv) {
    ...
    archivo << "Sudoku de tamaño " << p->tam << "x" << p->tam << "\n\n";
    ...
    archivo << "Parametros:    - Tamano poblacion: " << popsize << endl;
    archivo << "               - Numero de generaciones: " << ngen << endl;
    archivo << "               - Probabilidad cruce: " << pcross << endl;
    archivo << "               - Probabilidad mutacion: " << pmut << endl << endl;
    ...
    archivo << "El GA encuentra la solucion\n\n" << res << endl;

    archivo << "con valor fitness " << ga.statistics().minEver() << endl;
